...
void RailibDrawLine(int startPosX, int startPosY, int endPosX, int endPosY, Color color)
{
...
void MyDrawLine(int startPosX, int startPosY, int endPosX, int endPosY, Color color)
{
    rlColor4ub(color.r, color.g, color.b, color.a);
...
int main(void)
{
    ...
    while (flag)    // Detect window close with Start button
    {
        ...
        BeginDrawing();
            ...
            //RailibDrawLine(10, 10, 200, 10, BLACK);


            //MyDrawLine(10, 10, 10, 200, BLUE);

            
            //DrawTriangle((Vector2){ screenWidth/4.0f *3.0f+30.0f, 60.0f },
             //            (Vector2){ screenWidth/4.0f *3.0f, 110.0f },
             //            (Vector2){ screenWidth/4.0f *3.0f + 60.0f, 110.0f }, BLACK);
